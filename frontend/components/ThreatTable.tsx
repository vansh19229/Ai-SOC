...
export default function ThreatTable({ threats, loading, pagination, onPageChange, onAnalyze }: ThreatTableProps) {
  ...
  const [explainThreat, setExplainThreat] = useState<Threat | null>(null);
  ...
  return (
    <>
      ...
      <ThreatExplainer threat={explainThreat} onClose={() => setExplainThreat(null)} />
    </>
  );
}
